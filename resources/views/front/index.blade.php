 ...
 @section('content')
     ...
     <div class="banner_slider_wrapper">
         <div class="banner_slider banner_slider_2">
             <div class="slide">
                 <div class="slide_img" style="background-image: url({{asset('images/silde1.jpg')}});"></div>
                                 ...
                                 <div class="slide__content--headings text-center">
                                     <div >
                                         <h3  data-animation="fadeInDown">
                                             <span class="num" style="color: #ffffff">La Tulipe Food</span>
                                             <span></span>
                                         </h3></div>
                                     <h2  data-animation="fadeInDown" style="color: #FFF">Votre satisfaction, notre priorité</h2>
             ...
             <div class="slide">
                 <div class="slide_img" style="background-image: url({{asset('images/slide2.jpg')}});"></div>
                 <div class="slide__content">
                     <div class="container">
                         <div class="row">
                             <div class="col-lg-12">
                                 <div class="slide__content--headings text-center">
                                     <h3  data-animation="fadeInDown">
                                         <span class="num">La Tulipe Food</span>
                                         <span></span>
                                     </h3>
                                     <h2  data-animation="fadeInDown">Votre satisfaction, notre priorité</h2>
                                     <div class="margin_top40 res-767-margin_top30 margin_bottom60 res-991-margin_bottom0" data-animation="fadeInUp" data-delay="1.4">
                                         <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-rounded ttm-btn-style-fill ttm-btn-color-skincolor" href="{{url('qui-sommes-nous')}}">En savoir plus</a>
                                     </div>
                                 </div>
             ...
             <div class="slide">
                 <div class="slide_img" style="background-image: url({{asset('images/rognon_tulipe.jpeg')}});"></div>
                 <div class="slide__content">
                     <div class="container">
                         <div class="row">
                             <div class="col-lg-12">
             ...
             <div class="slide">
                 <div class="slide_img" style="background-image: url({{asset('images/queue-de-boeuf.webp')}});"></div>
                 <div class="slide__content">
                     <div class="container">
                         <div class="row">
                             <div class="col-lg-12">
             ...
             <div class="container">
                 <div class="row">
                     <div class="col-lg-6">
                         ...
                         <img class="img-fluid ttm-equal-height-image" src="{{asset('images/AA_63.jpeg')}}" alt="bg-image">
                     </div>
